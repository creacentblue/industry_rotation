...
def plot_result(result_dict, show_windows=True, savefile=None):
    ...
    std_line = pickle.load(open(r'E:\WANGZEYU\demo\industryAR\short_line.pkl', 'rb'))
    portfolio2 = std_line['sys_analyser']['portfolio']
    ...
    summary2 = std_line['sys_analyser']['summary']
    ...
    gs = gridspec.GridSpec(max_height+6, 8)
    ...
    fig_data = [
        ...
        (0.00, label_height2, value_height2, _(u"Benchmark Returns"), "{0:.3%}".format(summary2.get("total_returns", 0)), blue,
         black),
        (0.15, label_height2, value_height2, _(u"Benchmark Annual"), "{0:.3%}".format(summary2.get("annualized_returns", 0)),
         blue, black),
    ...
    ax.plot(portfolio2["unit_net_value"] - 1.0, label=_(u"strategy"), alpha=1, linewidth=2, color=blue)


    ax=plt.subplot(gs[10:16,:])
    ax.plot(portfolio["unit_net_value"]-portfolio2["unit_net_value"],label=_(u"多头")+'-'+_(u"空头"),alpha=1,linewidth=2,color='g')
